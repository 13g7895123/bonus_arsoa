                    ...
                    <td>                    	 
                    	          ...
                    	          <table class="table table-bordered" id="sample_list">                    	 	 
                    	           ...
                    	           <tr>
                    	              ...
                    	              <a class="btn btn-sm btn-warning text-white" style="background-color: #17a2b8;border-color: #17a2b8;" href="<?=base_url('wadmin/sample/charge_list/F002/'.$rs['s_id'])?>" target="sample_<?=$rs['s_id']?>"><span class="lnr lnr-users"></span> 申請檢視</a>                    	
                    	             
                    	              <a class="btn btn-sm btn-warning text-white" style="background-color: #17a2b8;border-color: #17a2b8;" href="<?=base_url('wadmin/sample/excel_export/'.$rs['s_id'].'')?>" target="_blank"><span class="lnr lnr-pie-chart"></span> 匯出Excel</a>                    	           
                    	              <?php }else{ 
                    	              	          echo '尚無索取人數';                    	 	                  
                    	 	                  } ?>
                    	            </td>
