...
<body>
    <div class="admin-container">
        ...
        <div class="page-header">
            <h2><i class="fas fa-file-alt"></i> 會員服務追蹤管理表(保健)</h2>
    ...
    $(document).ready(function() {
        ...
        function loadData(page = 1) {
            ...
            $.ajax({
                url: '<?php echo base_url("api/eeform/eeform4/list"); ?>',
                method: 'GET',
                data: {
                    page: page,
                    limit: itemsPerPage,
        ...
        $(document).on('click', '.view-detail', function() {
            ...
            $.ajax({
                url: '<?php echo base_url("api/eeform/eeform4/submission"); ?>/' + id,
                method: 'GET',
                success: function(response) {
                    if (response.success) {
        ...
        function renderDetailModal(data) {
            ...
            if (data.health_concerns) {
                ...
                html += '<h6>健康困擾</h6>';
                html += '<div class="detail-row"><span class="detail-value">' + (data.health_concerns || '-') + '</span></div>';
                html += '</div>';
            }
        ...
        $(document).on('click', '.delete-item', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo base_url("api/eeform/eeform4/delete"); ?>/' + id,
                        method: 'DELETE',
                        success: function(response) {
                            if (response.success) {
        ...
        $(document).on('click', '.export-excel', function() {
            const id = $(this).data('id');
            window.location.href = '<?php echo base_url("api/eeform/eeform4/export"); ?>/' + id;
        });
        ...
        function loadProducts() {
            $.ajax({
                url: '<?php echo base_url("api/eeform/eeform4/products"); ?>',
                method: 'GET',
                success: function(response) {
                    if (response.success) {
