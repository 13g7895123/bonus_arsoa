...
29. 調整一下/eform/eform2這一頁，請參考eform/eform1，填寫完姓名與出生年月日時會有一個打API驗證，並且送出的時候會打API去得會員編號，並送到後端，幫我為eform2補上這段，請確認是否路由有錯誤，他出現404錯誤，API是這一支/api/eeform2/ww_chkguest_test，請確認更新後是否有git更新了，一樣的錯誤，請確認route.php與config.php是否有需要調整或是更新
