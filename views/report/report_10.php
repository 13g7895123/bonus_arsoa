	            ...
	            $nm = 0;
	           	if ($q_data){
                           ...
                           <tr bgcolor="#bfbfbf">                            
                            ...
                            <td align=center class="font13">進貨單價</td>
                            <td align=center class="font13">數量</td>
                            <td align=center class="font13">進貨金額</td>
                            <td align=center class="font13">建議售價總額</td>
                           </tr>
	           	        <?php } ?>
	                     <tr>	           	        	 
                         ...
                         <td align=right class="font13"><?=number_format($rs["year_sale"])?></td>
	           	         </tr>
	                    <?php
	                    $u_price = $u_price + $rs["u_price"];
	           	        $qty     = $qty  + $rs["qty"];
	           	        $amt     = $amt  + $rs["amt"];
	           	        $year_sale  = $year_sale  + $rs["year_sale"];
	           	     }  ?>	           
	                 <tr bgcolor="#DDDDDD">
                         ...
                         <td align=right class="font13"><?=number_format($year_sale)?></td>
	           	         </tr>	  	                     
	             </table>   
