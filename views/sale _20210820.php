            ...
            <div class="container">
              <div class="row">
                <div class="col-md-9 mb130 mt-lg-0" role="main">
                  ...
                  <div class="mb65">                       
                        <div class="pt-1 pb-1 text-grey fs18"><strong>目前尚無販促活動！</strong></div>
                  </div>
          <?php }else{ 
                                ...
                                ?>                                      	
		           		             <div class="row border py-3 my-5 mx-0">
		           		           	  <div class="col-md-7 col-sm-12">
		           		           		  <a href="javascript:void(0);" title="<?=$item['title']?>" onclick="show_sale('<?=trim($item["id"])?>','<?=trim($item["title"])?>',<?=$n?>)"><img src="<?=base_url('public/func/'.$item['field1'])?>" class="img-fluid" alt="<?=$item['title']?>"></a>
		           		           	  </div>
                                            ...
                                            <div class="col-md-5 col-sm-12">
                                              <h4 class="article-author-name"><?=$item['title']?></h4>
		           		           		  ...
		           		           		  <a href="javascript:void(0);" onclick="show_sale('<?=trim($item["id"])?>','<?=trim($item["title"])?>',<?=$n?>)" class="btn btn-outline-info btn-sm w-100">活動詳情</a>
		           		           		  </div>
...
function show_sale(sid,stitle,sn)
{   
