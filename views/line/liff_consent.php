          ...
          <div class="section-item text-center">          	
            <div class="container">				   
            	<div class="row justify-content-center">
                   ...
                   <h1 class="h2-flash font-abril mb65"><?=$data['c_title']?></h1>                
...
function initializeApp() {
   ...
   {*/
        if(!liff.isLoggedIn()) {        
            liff.login({ redirectUri: "<?= base_url()?>consent/liff/<?=$query?>" });            
        }
        else {  
