          ...
          <div class="section-item text-center">          	
            <div class="container">				   
            	<div class="row justify-content-center">
                   ...
                   <h3 class="section-item-title-xs">Arsoa Question</h3>
                
                   <blockquote class="blockquote blockquote-status text-center my-3">
                     <div class="font-libre">問卷填寫</div>
                   </blockquote>                                                   
...
function initializeApp() {
    ...
    */
        if(!liff.isLoggedIn()) {        
            liff.login({ redirectUri: "<?= base_url()?>line/question/<?=$query?>/S" });            
        }
        else {  
        	  /*        
            liff.getFriendship().then(data => {                
                ...
                */
                    liff.getProfile().then(function(profile) {       
                        ...
                        $.ajax({
                            type: "POST",
                            url: '<?= base_url()?>line/question_receive/<?=$dev?>',
                            data: {
