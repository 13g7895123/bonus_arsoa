					  ...
					  <?php 
					        ...
					        if ($pckpro1){ 		
					  	        ?>
					  					<div class="col-md-12">
											  <div class="card mb-3">
            					        <div class="card-header"><div style="float:left"><h4 class="mb-0">基本組合</h4></div><div style="float:left">&nbsp;<?php if ($pckpro1_selcnt > 0 && $pckpro1_count > 1){ echo '<font color=red>請選擇'.$pckpro1_selcnt.'個專案</font>'; } ?></div></div>
            					        <div class="card-body">					  					
            									   ...
            									   <table class="table table-striped mb-2 text-center">
            									   	...
            									   	foreach ($pckpro1 as $key => $item){ 
            									              ...
            									              <tr>
            									              	...
            									              	if ($pckpro1_checkbox){
            									              		  ?>
            									              		  <td><input type="checkbox" name="sel_prd[]" id="sel_prd" value="<?=trim($item['p_no'])?>" <?=$i_checked?>></td>
            									              		  <?php
            									              	}
            									              	?>
					...
					<div class="row">
					  <div class="col-md-12 text-right">
						  <div class="btn-group" role="group" aria-label="">							  
							  <a href="<?=base_url('member_join/form')?>" class="btn btn-outline-secondary"><i class="icon ion-ios-cart"></i>　回上頁</a> 
