                    ...
                    <div class="container">
                      <form action="#" class="text-left">
                        <div class="row">
                              ...
                              <div class="card-body">
                               ...
                               <tbody>
                                <tr style="background-color: #E4FBFC;">
                                   <td nowrap="nowrap" class="text-center">2022-08-17</td>
                                   <td>62</td>
                                   <td>65</td>
                                   <td>118</td>
								   <td>90</td>
								   <td><span class="badge badge-primary">手</span> <span class="badge badge-warning">運</span> <span class="badge badge-success">健</span> <span class="badge badge-info">微</span> <span class="badge badge-secondary">水</span></td>
                                   <td><a href="javascript:void();" onclick="javascript:;" data-toggle="modal" data-target="#form03view">
												   <i class="icon ion-clipboard" style="font-size: 1.1rem;"></i>
											   </a>　｜　
											   <a href="javascript:void();" onclick="javascript:;" data-toggle="modal" data-target="#form03edit">
												   <i class="icon ion-edit" style="font-size: 1.1rem;"></i>
											   </a></td>
                                 </tr>
								   
								 <tr style="background-color: #eeeeee;">
                                   <td nowrap="nowrap" class="text-center">2022-08-19</td>
                                   <td>62.5</td>
                                   <td>65</td>
                                   <td>118</td>
								   <td>98</td>
								   <td><span class="badge badge-primary">手</span> <span class="badge badge-success">健</span> <span class="badge badge-info">微</span></td>
                                   <td><a href="javascript:void();" onclick="javascript:;" data-toggle="modal" data-target="#form03view">
												   <i class="icon ion-clipboard" style="font-size: 1.1rem;"></i>
											   </a>　｜　
											   <a href="javascript:void();" onclick="javascript:;" data-toggle="modal" data-target="#form03edit">
						  ...
						  <div class="col-sm-12 mb30">
							  <hr class="my-4">
							  <a href="eform03.php" class="btn btn-outline-danger btn-block">填寫微微卡日記</a>
							</div>
                    ...
                    <div class="container">
                      <form action="#" class="text-left">
                        <div class="row">
						  ...
						  <div class="col-sm-12 mb30">
							  <hr class="my-4">
							  <a href="eform03_list.php" class="btn btn-outline-danger btn-block">送出表單</a>
							</div>
