          ...
          <div class="section pp-scrollable slide slide2">
            <div class="slide-container">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="solution-num text-texture">49</div>
                    ...
                    <div class="accordion solution-collapse" id="solutions">
                      <div class="solution-collapse-item">
                        ...
                        <div id="solution1"  class="collapse show" aria-labelledby="headingOne" data-parent="#solutions">
                          <div class="card-body">
                            從追求「量」到重視「質」、從重視「物質」到追求「心靈」。其實，世人的價值觀已出現極大的變化。身處於這樣的時代裡才終於體會到，唯有真心感到滿足的事物，才能帶來真正的幸福。安露莎率先洞悉到這個時代的變化，並已邁向創造新價值之路。.... <a href="#">See more</a>
                          </div>
                        </div>
                      </div>
                      <div class="solution-collapse-item">
                        ...
                        <div id="solution2" class="collapse" aria-labelledby="headingTwo" data-parent="#solutions">
                          <div class="card-body">
                            安露莎確信，「心、體、肌」三大健康中，存在著誕生真善美的「三健精神」概念、及置身於大自然中，重新調整平衡的重要性。另外，透過親手栽種農作物，而實際體會到該如何珍惜每天應有的「飲食」態度下，目前已著手研究生機延壽飲食法(Macrobiotic).... <a href="#">See more</a>
                          </div>
                        </div>
                      </div>
                      <div class="solution-collapse-item">
                        ...
                        <div id="solution3" class="collapse" aria-labelledby="headingThree" data-parent="#solutions">
                          <div class="card-body">
                            為了與自然融為一體，我們抱持向大自然學習的態度，提倡並加以實踐與自然合而為一的生活方式。在大自然提供的生存環境中，我們感受生命的氣息，心靈也獲得豐富的滋養，並且重視自然環境的維護。.... <a href="#">See more</a>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <ul class="step">
          <li class="step1 fadeup active">
            ...
            <p>護膚首重「清潔」，<br>
              為喚醒肌膚原有能力而誕生的「蜜皂」，<br>
              是安露莎的原點。</p>
            <a href="products.html" class="btn">觀看商品</a>
          </li>
              ...
              <div class="container">
                <div class="slide-body">
                  <div class="row no-gutters partner-bordered">
                    <div class="col partner-item"><span class="inside"><img src="<?=base_url()?>public/images/p01.png" alt="肌膚保養系列" /><br><h4 class="my-2">肌膚保養系列</h4><p>專為肌膚而進化的，安露莎系列保養品。</p><a href="<?=base_url('category/skin')?>" type="button" class="btn btn-outline-secondary btn-sm text-secondary">更多｜More</a></span></div>
                    <div class="col partner-item"><span class="inside"><img src="<?=base_url()?>public/images/p02.png" alt="彩妝系列" /><br><h4 class="my-2">彩妝系列</h4><p>基礎彩粧是肌膚保養的延伸，展現美感造型同時呵護肌膚。</p><a href="<?=base_url('category/makeup')?>" type="button" class="btn btn-outline-secondary btn-sm text-secondary">更多｜More</a></span></div>
                    <div class="col partner-item"><span class="inside"><img src="<?=base_url()?>public/images/p03.png" alt="保健食品系列" /><br><h4 class="my-2">保健食品系列</h4><p>肌膚是反映健康狀態的明鏡，裡外兼顧創造美與健康。</p><a href="<?=base_url('category/health')?>" type="button" class="btn btn-outline-secondary btn-sm text-secondary">更多｜More</a></span></div>
					          <div class="col partner-item"><span class="inside"><img src="<?=base_url()?>public/images/p04.png" alt="健康飲用水系列" /><br><h4 class="my-2">健康飲用水系列</h4><p>享受健康、純淨、甘甜的好水，是身體的基本渴求。</p><a href="<?=base_url('category/clean')?>" type="button" class="btn btn-outline-secondary btn-sm text-secondary">更多｜More</a></span></div>
                    <div class="col partner-item"><span class="inside"><img src="<?=base_url()?>public/images/p05.png" alt="美髮、美體系列" /><br><h4 class="my-2">美髮、美體系列</h4><p>植物性溫泉水及天然香氛、呵護滋潤每一吋肌膚。</p><a href="<?=base_url('category/hair_body')?>" type="button" class="btn btn-outline-secondary btn-sm text-secondary">更多｜More</a></span></div>
                    <div class="col partner-item"><span class="inside"><img src="<?=base_url()?>public/images/p06.png" alt="輔銷產品" /><br><h4 class="my-2">輔銷產品</h4><p>整在代回能話他木星或精下：吃書不次出星量成性衣不天方溫？具重遠性趣展</p><a href="<?=base_url('category/other')?>" type="button" class="btn btn-outline-secondary btn-sm text-secondary">更多｜More</a></span></div>
                  </div>
                </div>
              </div>
            </div>
