             ...
             <div class="container">              
               <div class="row">
                ...
                <div class="col-lg-6 mb130" role="main">
                  ...
                  <?php }else{ ?>
                              <h5 class="mb45">請輸入您的會員編號以及密碼登入綁定 Line</h5>                  
                              ...
                              <form name="oForm" method="post" action="<?=$action?>" class="mb40 wow fadeInUp" data-wow-delay=".3s">
                               ...
                               <div class="log-input">
								                  <div class="log-input-center" >
                                        <div class="alert alert-success" role="alert" style="font-size: 1.25rem;">
                                           親愛的 <?=$this->session->userdata('line_display_name')?> 您好：<br><br>您的 Line 帳號尚未綁定會員帳號，請於上方輸入會員編號以及密碼綁定 安露莎官方Line！<br>                	                                                       	
                                        </div>
                                        
                                        <div style="text-align: center;">
                                           <a href="<?=base_url('line/logout')?>" class="btn btn-warning" role="button" aria-pressed="true">不以 Line 帳號登入</a>
                                        </div>
